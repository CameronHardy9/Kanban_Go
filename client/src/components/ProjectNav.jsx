                ...
                <details>
                    ...
                    <ul className="projectNavLinks">
                        {Object.keys(this.props.projects).map((item, index) => {
                            return (
                                <li key={index}>
                                    <button onClick={() => this.props.handleDeleteProject(item)} className="deleteButtons deleteProject">
